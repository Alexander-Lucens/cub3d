...
=======
/*   Updated: 2025/10/20 15:19:29 by akuzmin          ###   ########.fr       */
...
char **create_mock_map(void) {
	char **map = ft_calloc(sizeof(char*), 14);
	if (!map)
		return exit(1);
	...
	map[6] = "11110110001111011100000010001";
	map[7] = "11110111111111011101010010001";
	map[8] = "11000000110101011100000010001";
	map[9] = "10000000000000000000000010001";
